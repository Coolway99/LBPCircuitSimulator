...
public abstract class ILogicGate implements ILogicDraggable, LogicInputListener, LogicOutputListener{
	...
	private static Image backgroundImage = 
			new ImageIcon(Main.class.getResource("assets/logicBackground.png")).getImage();
	...
	/**
	 * Called when the gate is supposed to evaulate it's inputs and then do other internal calculations
	 */
	...
	/**
	 * @return A rectangle representing the size in grid amounts (1 grid square = 1 circuit node)
	 */
	 ...
	 * The image should be white and black/transparent as it will be hue changed to the colors set
	 * @return The Icon used for the front, null if no icon
	 * @see getBackgroundIcon
	 */
	public abstract Image getForegroundImage();
	/**
	 * <b>THIS CLASS IS ALREADY DEFINED FOR YOU, ONLY OVERRIDE IF YOU WANT TO CHANGE THE DEFAULT</b><br />
	 ...
	 * @return The Icon used for the back, null if no icon
	 * @see getForegroundIcon
	 */
	public Image getBackgroundImage(){
		return ILogicGate.backgroundImage;
	}
}
